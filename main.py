...
notes_win.setStyleSheet("background-color:pink; color:blue;font-size:16px")
button_note_create = QPushButton('Створити замітку' )
button_note_del = QPushButton('Видалити замітку')
button_note_save = QPushButton ('3берегти замітку')
button_note_create.setStyleSheet("background-color:fuchsia;")
button_note_del.setStyleSheet("background-color:fuchsia")
button_note_save.setStyleSheet("background-color:fuchsia")
field_tag =QLineEdit("")
...
button_tag_add.setStyleSheet("background-color:fuchsia")
button_tag_del.setStyleSheet("background-color:fuchsia")
button_tag_search.setStyleSheet("background-color:fuchsia")
